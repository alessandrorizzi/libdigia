...
//    closeButtonPixmap(QLatin1String(":/core/images/inputfield.png"))
{
}
...
//             painter->fillRect(filledRect, option->palette.base());
            ...
            if (option->state & State_Enabled)
                StyleHelper::drawCornerImage(d->lineeditImage, painter, option->rect, 2, 2, 2, 2);
            else
                StyleHelper::drawCornerImage(d->lineeditImage_disabled, painter, option->rect, 2, 2, 2, 2);
